...
Nama output release mengikuti format `control-droid-<versionName>-<versionCode>.apk`, contohnya `control-droid-1.0.2-3.apk`, di bawah `app/build/outputs/apk/release/`.
