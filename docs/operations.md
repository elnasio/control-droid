...
Nama output release mengikuti format `control-droid-<versionName>-<versionCode>.apk`, contohnya `control-droid-1.0.4-5.apk`, di bawah `app/build/outputs/apk/release/`.
